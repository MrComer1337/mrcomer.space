...
function renderTime() {
    ...
    o.innerHTML = `<span class="clock-hover">${[t, ':', i, ':',a, ' ', r].join('</span><span class="clock-hover">')}</span>`;
    // o.innerText = t + ":" + i + ":" + a + " " + r
}
canvas.addEventListener("mousemove", function(e) {
    ++count > 25 && (colorArr = [Math.random() + .2, Math.random() + .2, Math.random() + .2], count = 0), pointers[0].down = !0, pointers[0].color = colorArr, pointers[0].moved = pointers[0].down, pointers[0].dx = 10 * (e.offsetX - pointers[0].x), pointers[0].dy = 10 * (e.offsetY - pointers[0].y), pointers[0].x = e.offsetX, pointers[0].y = e.offsetY
